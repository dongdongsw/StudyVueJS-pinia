    ...
    <div class="container">
        <div class="row">
                ...
                <tbody>
                    <tr>
                        <td width="30%" class="text-center" rowspan="8">
                            <img :src="vo.poster" style="width:220px;height: 220px;">
                        </td>
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="text-center" style="color:gray" width="15%">영업 시간</td>
            ...
            <table class="table">
                ...
                <tr>
                    <td class="text-right">
                        <router-link class="btn btn-sm btn-primary a-link" to="/">목록</router-link>
                    </td>
                </tr>
